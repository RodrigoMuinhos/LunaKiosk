...
Também existe um empacotamento **Electron** (Windows) que embute a UI do Totem (Next standalone) e pode iniciar automaticamente os backends (LunaCore/TotemAPI/LunaPay).
